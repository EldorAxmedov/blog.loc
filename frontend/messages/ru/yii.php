...
return [
    ...
    'We are an IT company offering various IT services'=>'Мы ИТ-компания, предлагаем различные ИТ-услуги',
    'More details'=>'Подробнее',
    'Services'=>'Наши услуги',
    'Web programming'=>'Веб программирование',
    'IT services is a list of ready-made methods and solutions for qualified support in the field of information technology, in simple terms.'=>'ИТ-услуги — это перечень готовых способов и решений квалифицированной поддержки в области информационных технологий, если говорить простыми словами.',
    'Development of high-quality sites: business cards, landing pages, online stores, catalogs, blogs. Site name selection, registration, hosting.'=>'Разработка качественных сайтов: визитки, лэндинги, интернет-магазины, каталоги, блоги. Подбор имени сайта, регистрация, размещение на хостинге.',
    'Network and networking equipment'=>'Сеть и сетевое оборудование',
    'Our specialists carry out installation of any complexity and structure. From the computer network of a small office to the cable networks of an office complex.'=>'Наши специалисты осуществляют монтаж любой сложности и структуры. От компьютерной сети небольшого офиса до кабельных сетей комплекса офисных зданий.',
    'Video surveillance service'=>'Обслуживание видеонаблюдения',
    'We are ready to offer you low prices for video surveillance equipment and calculate the installation of video surveillance at your facility.'=>'Мы готовы, вам предложить низкие цены на оборудования по видеонаблюдения и рассчитать монтаж видеонаблюдения на вашем объекте.',
    'About'=>'О нас',
    ...
    'Любые компании, предприятия и организации осуществляют свою деятельность при помощи информации. Это самый востребованный продукт в наше время, который помогает стремительно развивать бизнес в самых различных отраслях.',
    ...
    'Для оперирования данными, их получения, обработки и передачи необходим ряд оборудования, программного обеспечения и услуг, которые предоставляют IT компании.',
    ...
    'Мы специализируемся на разработке и внедрении системных решений в области современных информационных технологий. Основная наша задача – найти оптимальные формы взаимовыгодной работы с клиентом. Для этого мы прилагаем все усилия, направленные на развитие и совершенствование предоставляемых нами услуг и технологий.',
    'Our advantages'=>'Наши преимущества',
    'Simplicity and openness of communication'=>'Простота и открытость коммуникаций',
    'Formation of effective teams'=>'Формирование эффективных комманд',
    'Adaptability to customer processes'=>'Адаптивност к процессам заказчика',
    'Quality and terms'=>'Качество и сроки',
    'Cost control'=>'Контроль над затратами',
    'Reliability guarantees'=>'Гарантии надежности',
    'Saving money'=>'Экономия средств',
    'Website development'=>'Создание веб сайтов',
    'All'=>'Все',
    'Website'=>'Веб сайты',
    'Network hardware'=>'Сетевое оборудование',
    'Video surveillance'=>'Видеонаблюдение',
    'A quality website that we will develop for you'=>'Качественный сайт, который мы для вас разработаем',
    'We offer our clients a wide range of networking services'=>'Мы предлагаем нашим клиентам широкий спектр сетевых услуг',
    'A wide range of services for the design, maintenance and installation of video surveillance systems'=>'Широкий спектр услуг по проектированию, обслуживанию и монтажу систем видеонаблюдения',
    'Our team'=>'Наша команда',
    'Our team and experience for the implementation of your IT projects!'=>'Наша команда и опыт для реализации ваших ИТ-проектов!',
    'Axmedov Eldor'=>'Ахмедов Элдор',
    'Xayridinov Asan'=>'Хайридинов Асан',
    'Turopov Tohir'=>'Туропов Тохир',
    'Yangiboyev Ro\'zimurod'=>'Янгибоев Рузимурод',
    'Web developer'=>'Веб разработчик',
    'Network administrator'=>'Сетевой администратор',
    'System administrator'=>'Системный администратор',
    'Last news'=>'Последние новости',
    'Useful articles and reviews for clients and everyone interested'=>'Полезные статьи и обзоры для клиентов и всех интересующихся',
    'News'=>'Новости',
    'Category'=>'Категории',
];
